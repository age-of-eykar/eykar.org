...
import Panel from './notifs/panel';

function Header() {
    const router = useRouter()
    const { transactions } = useStarknetTransactionManager()
    const [hasPanel, togglePanel] = useState(false)
        ...
        <>
            <nav className={styles.game_nav}>
                <div className={styles.icons}>
                    ...
                    <div onClick={() => router.push("/game/empire")} className={[styles.button, page === "empire" && !hasPanel ? styles.highlighted : styles.normal, styles.button_div].join(" ")}>
                    ...
                    <div onClick={() => router.push("/game/world")} className={[styles.button, page === "world" && !hasPanel ? styles.highlighted : styles.normal, styles.button_div].join(" ")}>
                    ...
                    <div onClick={() => router.push("/game/trade")} className={[styles.button, page === "trade" && !hasPanel ? styles.highlighted : styles.normal, styles.button_div].join(" ")}>
                    ...
                    <div onClick={() => togglePanel(!hasPanel)} className={[styles.button, hasPanel ? styles.highlighted : styles.normal, styles.button_div].join(" ")}>
            ...
            {
                hasPanel ? <Panel toggle={togglePanel} /> : null
            }
        </>
    );
